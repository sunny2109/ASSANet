...
from MAE.dataset import ImgMaskDataset, RealImgDataset
...
def get_args_parser():
    ...
    parser.add_argument('--meta_info_file', type=str, default='train_list.txt', help='Indicate where is the training set')
...
def main(args):
    ...
    dataset_train = RealImgDataset(args.data_path, meta_info_file=args.meta_info_file, image_size=args.input_size)
    print(dataset_train)
