...
def main():
    ...
    # HR images
    opt['input_folder'] = '/data0/SISR_dataset/LSDIR/HR' #'datasets/DIV2K/DIV2K_train_HR'
    opt['save_folder'] = '/data0/SISR_dataset/LSDIR/HR_sub' #'datasets/DIV2K/DIV2K_train_HR_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = '/data0/SISR_dataset/LSDIR/LRBI/x4' #'datasets/DIV2K/DIV2K_train_LR_bicubic/X4'
    opt['save_folder'] = '/data0/SISR_dataset/LSDIR/LRBI/x4_sub' #'datasets/DIV2K/DIV2K_train_LR_bicubic/X4_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
