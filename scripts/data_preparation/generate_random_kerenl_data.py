...
if __name__ == '__main__':
    ...
    images_path = '/data0/SISR_dataset/LSDIR/HR/'
    output_path = '/data0/SISR_dataset/LSDIR/RKLR/x4'
    ...
    for filename in tqdm(os.listdir(images_path)):
        ...
        lr = downscale(img, kernel, scale_factor)

        lr = Image.fromarray(lr, mode="RGB")
        lr.save(os.path.join(output_path, f"{img_name}x{scale_factor[0]}.png"))
