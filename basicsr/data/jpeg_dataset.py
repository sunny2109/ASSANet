...
class DatasetJPEG(data.Dataset):
    def __init__(self, opt):
        ...
        self.quality_factor = opt['quality_factor'] if 'quality_factor' in opt else 40
        self.quality_factor_test = opt['quality_factor_test'] if 'quality_factor_test' in opt else 40
        self.is_color = opt['is_color'] if 'is_color' in opt else False
